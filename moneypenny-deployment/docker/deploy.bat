...
::   deploy.bat up -e dev -b moneypenny-api   Brings up the services for the 'dev' environment and builds specified containers
...
set "BASE_IMAGES=moneypenny-api-base moneypenny-frontend-base"
